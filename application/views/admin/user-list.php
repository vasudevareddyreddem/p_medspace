									...
									<?php foreach($user_list as $list){ ?>
                                        ...
                                        <tr>
                                           ...
                                           <td><?php if($list['status']==1){ echo "Active"; }else{ echo "Deactive";} ?></td>
											...
											<a href="<?php echo base_url('user/status/'.base64_encode($list['a_id']).'/'.base64_encode($list['status'])); ?>" class="btn btn-sm btn-primary"><?php if($list['status']==0){ echo "Active"; }else{ echo "Deactive";} ?></a> 
											<a href="<?php echo base_url('user/delete/'.base64_encode($list['a_id'])); ?>" class="btn btn-sm btn-primary">Delete</a> 
											</td>
                                        </tr>
